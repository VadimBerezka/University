...
BEGIN
    ...
    SELECT 
        'INS',
        'TR_TEACHER_INS',
        'TEACHER: ' + CAST(TEACHER AS VARCHAR) + 
        ', NAME: ' + TEACHER_NAME + 
        ', GENDER: ' + GENDER + 
        ', PULPIT: ' + PULPIT
    FROM INSERTED;
...
BEGIN
    ...
    SELECT 
        'UPD',
        'TR_TEACHER_UPD',
        'BEFORE: TEACHER=' + CAST(d.TEACHER AS VARCHAR) + 
        ', NAME=' + d.TEACHER_NAME + 
        ', GENDER=' + d.GENDER + 
        ', PULPIT=' + d.PULPIT + 
        ' | AFTER: TEACHER=' + CAST(i.TEACHER AS VARCHAR) + 
        ', NAME=' + i.TEACHER_NAME + 
        ', GENDER=' + i.GENDER + 
        ', PULPIT=' + i.PULPIT
    FROM DELETED d
...
UPDATE TEACHER
SET TEACHER_NAME = '—ÏÂÎÓ‚', GENDER = 'Ï'
WHERE TEACHER = '—ÃÀ¬';
SELECT * FROM #TR_AUDIT;
go
...
BEGIN
    ...
    BEGIN
        ...
        SELECT 
            'INS',
            'TR_TEACHER',
            'INSERTED: TEACHER=' + CAST(TEACHER AS VARCHAR) +
            ', NAME=' + TEACHER_NAME +
            ', GENDER=' + GENDER +
            ', PULPIT=' + PULPIT
        FROM INSERTED;
    ...
    BEGIN
        ...
        SELECT 
            'DEL',
            'TR_TEACHER',
            'DELETED: TEACHER=' + CAST(TEACHER AS VARCHAR) +
            ', NAME=' + TEACHER_NAME +
            ', GENDER=' + GENDER +
            ', PULPIT=' + PULPIT
        FROM DELETED;
